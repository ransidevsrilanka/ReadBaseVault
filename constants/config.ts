...
export const PAYHERE_MC_ID = process.env.EXPO_PUBLIC_PAYHERE_MC_ID || '1233393';
export const PAYHERE_MC_SECRET = process.env.EXPO_PUBLIC_PAYHERE_MC_SECRET || 'Mjk5MTM0MzExOTIxMTUwNDEzNzEzMzk3NDExMTI1MjQ2ODQwMDU2Ng==';
